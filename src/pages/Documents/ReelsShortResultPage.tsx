...
import ReelsShortPdfDocument from '../../features/documents/pdf/ReelsShortPdfDocument';
import { getDocumentSessionById } from '../../features/documents/services/documentSessions';
import { exportReelsShortDocx } from '../../features/documents/utils/exportReelsShort';
...
export default function ReelsShortResultPage() {
    ...
    async function loadDocument() {
      ...
      try {
        ...
        const { data: savedScripts, error: scriptLookupError } = await supabase
          ...
          .select('id')
          .eq('module', 'reels_scripts')
          .eq('script_type', 'short')
  ...
  async function trackFeedback(feedback: {
    ...
    try {
      ...
      if (feedbackError) {
        console.error('No se pudo guardar el feedback del guion:', feedbackError);
        return;
      }
      ...
      if (promoteError) {
        console.error('No se pudo reprocesar el guion para aprendizaje global:', promoteError);
      }
    } catch (error) {
  ...
  async function handleFavorite() {
    ...
    try {
      ...
      console.error(error);
      alert('No se pudo marcar el guion como favorito.');
    } finally {
  ...
  async function handleExportDocx() {
    try {
      ...
      await exportReelsShortDocx(generatedContent);
            ...
            <>
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-between">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  ...
                  <PDFDownloadLink
                    document={<ReelsShortPdfDocument data={generatedContent} />}
