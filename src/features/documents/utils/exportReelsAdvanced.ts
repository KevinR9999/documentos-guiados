...
export async function exportReelsAdvancedDocx(
  ...
  if (generatedContent.persuasion_strategy) {
    children.push(
      new Paragraph({
        text: 'Estrategia de persuasion',
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 160, after: 160 },
      }),
      ...textToParagraphs(generatedContent.persuasion_strategy)
    );
  }
