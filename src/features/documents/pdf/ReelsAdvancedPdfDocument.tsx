...
export type ReelsAdvancedPdfData = {
  title?: string;
  objective?: string;
  angle?: string;
...
export default function ReelsAdvancedPdfDocument({
  data,
}: {
  data: ReelsAdvancedPdfData;
}) {
  return (
    <Document
    ...
    >
      <Page size="A4" style={styles.page}>
        ...
        {data.persuasion_strategy ? (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Estrategia de persuasion</Text>
            <View style={styles.sectionDivider} />
            <View>{renderParagraphs(data.persuasion_strategy)}</View>
          </View>
        ) : null}
